                ...
                <Grid alignItems="center" item xs={12}>
                    <Box className='footer'>
                        ...
                        <Box>
                            <Box className='redes'>
                                ...
                                <a href="https://www.instagram.com/jm.jeska/" target="_blank">
                                    <InstagramIcon className='redes' />
                                </a>
                                <a href="https://www.linkedin.com/in/jessicamoraessantos/" target="_blank">
                                    <LinkedInIcon className='redes' />
                                </a>
                                <a href="https://www.github.com/jeskamoraes/" target="_blank">
                    ...
                    {/* <Box className='box1'>
                        <Box paddingTop={1} display="flex" alignItems="center" justifyContent="center">
                            <Typography variant="h5" align="center" gutterBottom className='texto'>Redes sociais </Typography>
                        </Box>
